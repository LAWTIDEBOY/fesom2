...
Pstar=27500.0          ! [N/m^2]
ellipse=2.0
c_pressure=15.0        ! ice concentration parameter used in ice strength computation
delta_min=1.0e-11      ! [s^(-1)]
evp_rheol_steps=200    ! number of EVP subcycles
...
Cd_oce_ice=0.01      ! drag coef. oce - ice 
...
albsn=0.86             ! Albedo: frozen snow
albsnm=0.73            !         melting snow
albi=0.69              !         frozen ice
albim=0.65             !         melting ice
albw=0.1               !         open water
