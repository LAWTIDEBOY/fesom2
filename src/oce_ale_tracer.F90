...
! Nitrogen SS
!       if (NitrogenSS .and. tracer_id(tr_num)==1008) call recom_nitogenss(mesh) !nss for idetc
! 3) Nitrogen SS
...
use ver_sinking_recom_benthos_interface
    ...
    real(kind=WP)             :: Vben(mesh%nl),  aux(mesh%nl-1), flux(mesh%nl), add_benthos_2d(myDim_nod2D) !, LocDenit(mesh%nl-1)
