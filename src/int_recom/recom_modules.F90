...
Module REcoM_GloVar
  ...
  Real(kind=8),allocatable                :: SATfactor         ! Normalized Surface Air Temprature factor for varying erosion inputs [no unit]
  Real(kind=8),allocatable                :: runofffactor      ! Normalized runoff factor for varying erosion inputs [no unit]
