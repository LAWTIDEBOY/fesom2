...
!! *** General configuration ***
  ...
  Integer                :: bgc_num               = 22
  Integer                :: diags3d_num           = 18       ! Number of diagnostic 3d tracers to be saved
...
Module REcoM_GloVar
  ...
  Real(kind=8),allocatable,dimension(:,:) :: Benthos_flux     ! 4 types of benthos-tracers fluxes with size [n2d 4]
  ...
  Real(kind=8),dimension(1)              :: SATfactor         ! Normalized Surface Air Temprature factor for varying erosion inputs [no unit]
  Real(kind=8),dimension(1)              :: runofffactor      ! Normalized runoff factor for varying erosion inputs [no unit]
